...
#
# Created: Thu Mar 30 10:24:59 2017
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mode_list = QtGui.QComboBox(self.frameconfig)
        self.mode_list.setObjectName(_fromUtf8("mode_list"))
        self.mode_list.addItem(_fromUtf8(""))
        self.mode_list.addItem(_fromUtf8(""))
        self.mode_list.addItem(_fromUtf8(""))
        self.mode_list.addItem(_fromUtf8(""))
        self.mode_list.addItem(_fromUtf8(""))
        ...
        self.mode_list.addItem(_fromUtf8(""))
        self.mode_list.addItem(_fromUtf8(""))
        self.gridLayout_7.addWidget(self.mode_list, 2, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.mode_list.setItemText(0, _translate("MainWindow", "AX-12Wnomulti", None))
        self.mode_list.setItemText(1, _translate("MainWindow", "AX-12Anomulti", None))
        self.mode_list.setItemText(2, _translate("MainWindow", "AX-18nomulti", None))
        self.mode_list.setItemText(3, _translate("MainWindow", "EX-106+ nomulti", None))
        self.mode_list.setItemText(4, _translate("MainWindow", "RX-24F nomulti", None))
        self.mode_list.setItemText(5, _translate("MainWindow", "RX-28 nomulti", None))
        self.mode_list.setItemText(6, _translate("MainWindow", "RX-64 nomulti", None))
        self.mode_list.setItemText(7, _translate("MainWindow", "MX-12W ", None))
        self.mode_list.setItemText(8, _translate("MainWindow", "MX-28", None))
        self.mode_list.setItemText(9, _translate("MainWindow", "MX-64", None))
        self.mode_list.setItemText(10, _translate("MainWindow", "MX-106drive", None))
        self.mode_list.setItemText(11, _translate("MainWindow", "MX1062.0 NON SUPORTED", None))
